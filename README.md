...
👉 [**Click here to see the app running on
...
It provides a digital dashboard for material orders, worker shifts,
safety checks (PPE), and financial tracking --- all in one place. Built
with **Next.js, Prisma, Neon PostgreSQL, TailwindCSS** and deployed on
**Vercel**.

**TR**\
İnşaat sektörü için tasarlanmış bir SaaS demo uygulamasıdır.\
Malzeme siparişleri, vardiya planlaması, iş güvenliği (PPE) kontrolleri
ve finansal takip --- hepsi tek bir ekranda.\
**Next.js, Prisma, Neon PostgreSQL, TailwindCSS** ile geliştirildi,
...
-   📦 **Orders / Siparişler** → Cement, steel, brick, etc. order
    management.\
-   👷 **Shifts / Vardiyalar** → Worker check-in & check-out tracking.\
-   🦺 **PPE Checks / PPE Kontrolleri** → Helmet, harness, safety
    compliance.\
...
<p align="center">
```
`<img src="image.png" alt="Orçun | Full-Stack SaaS Developer" width="100%">`{=html}
```{=html}
</p>
```
